...
public class ImageController {
    ...
    private ImageUploadResponse upload(MultipartFile file, String namespace, UserAuth currentUser) throws IOException, ImageInvalidException {
        ...
        UploadProperties uploadProperties = this.uploadService.uploadImage(file, namespace, currentUser.getUsername(), 1200);
        response.setImageUrl("/images/" + uploadProperties.getUuid());
        uploadProperties = this.uploadService.uploadImage(file, namespace, currentUser.getUsername(), 600);
